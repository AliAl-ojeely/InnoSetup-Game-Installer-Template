...
#define MyAppName "Your Game Title"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "Your Studio Name"
...
#define MyAppId "{{PLACE-YOUR-NEW-GUID-HERE}"

; [REQUIRED CHANGE] Paths & Folders
; Set the exact path where your game files and assets are located on your PC.
; Example: "C:\MyGameProject\Release" or keep it as "{src}\GameFiles" for relative paths.
#define MyGameFilesDir "C:\Path\To\Your\Game\Folder"
#define MyAssetsDir "C:\Path\To\Your\Assets\Folder"
